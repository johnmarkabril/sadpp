...
<html lang="en">
	                ...
	                <div class="col-sm-12 block-3 section-description wow fadeIn">
						...
						<div id="search">
							...
							<table border="1">
								...
								<tr>
									<th><center> No. </th>
									<th><center> Number of Book </th>
									<th><center> Date of Wedding</th>
									<th><center> Male's Name </th>
									<th><center> Woman's Name </th>
									<th><center> Man's Status </th>
									<th><center> Woman's Status</th>
									<th><center> Man's Age </th>
									<th><center> Woman's Age </th>
									<th><center> Man's Address </th>
									<th><center> Woman's Address </th>
									<th><center> Father's Name </th>
									<th><center> Mother's Name </th>
									<th><center> Family Address </th>
									<th><center> Father's Name </th>
									<th><center> Mother's Name </th>
									<th><center> Family Address </th>
									<th><center> Godfather's Name </th>
									<th><center> Residence </th>
									<th><center> Godmother's Name </th>
									<th><center> Residence </th>
									<th><center> Minister </th>
									<th><center> Marriage License </th>
								</tr>
								<tbody class="list">
									<?php
									...
									?>
											<tr>
												<td class="no"><?php echo $row['no']; ?></td>
													<td class=""><?php echo $row['nob']; ?></td>
												<td class=""><?php echo $row['date']; ?></td>
												<td class="bname"><?php echo $row['bname']; ?></td>
												<td class="gname"><?php echo $row['gname']; ?></td>
												<td class=""><?php echo $row['bstatus']; ?></td>
												<td class=""><?php echo $row['gstatus']; ?></td>
												<td class=""><?php echo $row['bage']; ?></td>
												<td class=""><?php echo $row['gage']; ?></td>
												<td class=""><?php echo $row['badd']; ?></td>
												<td class=""><?php echo $row['gadd']; ?></td>
												<td class=""><?php echo $row['bparentf']; ?></td>
												<td class=""><?php echo $row['bparentm']; ?></td>
												<td class=""><?php echo $row['faddress']; ?></td>
												<td class=""><?php echo $row['gparentf']; ?></td>
												<td class=""><?php echo $row['gparentm']; ?></td>
												<td class=""><?php echo $row['gaddress']; ?></td>
												<td class=""><?php echo $row['ninong']; ?></td>
												<td class=""><?php echo $row['nresidence']; ?></td>
												<td class=""><?php echo $row['ninang']; ?></td>
												<td class=""><?php echo $row['gresidence']; ?></td>
												<td class=""><?php echo $row['minister']; ?></td>
												<td class="license"><?php echo $row['license']; ?></td>
											</tr>
									<?php
										}
									}
	...
	$(document).ready(function(){
		var options = {
			valueNames: [ 'no','bname', 'gname', 'license' ]
		};
