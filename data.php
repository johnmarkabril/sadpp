...
<html lang="en">
						...
						<div id="search">
							...
							<table border="1">
								...
								<tr>
									...
									<th><center> Date of Baptism </th>
									<th><center> First Name </th>
									<th><center> M.I. </th>
									<th><center> Last Name </th>
									<th><center>&nbsp;&nbsp;&nbsp;Birthday&nbsp;&nbsp;&nbsp;</th>
									<th><center> Legitimity </th>
									<th><center> Father's Name </th>
									<th><center> Place of Birth </th>
									<th><center> Mother's Name </th>
									<th><center> Place of Birth </th>
									<th><center> Address </th>
									<th><center> God Parents </th>
							...
							<tbody class="list">
									...
									?>
											<tr>
												...
												<td class=""><?php echo $row['mi']; ?></td>
												<td class="lastname"><?php echo $row['lastname']; ?></td>
												<td class="bday"><?php echo $row['bday']; ?></td>
												<td class=""><?php echo $row['leg']; ?></td>
												<td class=""><?php echo $row['fname']; ?></td>
												<td class=""><?php echo $row['pob1']; ?></td>
												<td class=""><?php echo $row['mname']; ?></td>
												<td class=""><?php echo $row['pob2']; ?></td>
												<td class=""><?php echo $row['address']; ?></td>
												<td class=""><?php echo $row['ninong']; ?></td>
												<td class=""><?php echo $row['rninong']; ?></td>
												<td class=""><?php echo $row['ninang']; ?></td>
												<td class=""><?php echo $row['rninang']; ?></td>
	...
	$(document).ready(function(){
		var options = {
			valueNames: [ 'lastname','firstname', 'bday' ]
		};
