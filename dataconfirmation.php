	                ...
	                <div class="col-sm-12 block-3 section-description wow fadeIn">
						...
						<div id="search">
							<div class="w3-container w3-lobster">
								<p class="w3-xxxlarge">Data of Confirmation</p>
							</div>
								...
								<tbody class="list">
									...
									?>
											<tr>
												...
												<td class="lname"><?php echo $row['fname']; ?></td>
												<td class=""><?php echo $row['lname']; ?></td>
												<td class=""><?php echo $row['age']; ?></td>
												<td class=""><?php echo $row['chch']; ?></td>
												...
												<td class=""><?php echo $row['pesos']; ?></td>
												<td class=""><?php echo $row['bishop']; ?></td>
											</tr>
									<?php
										}
									}
