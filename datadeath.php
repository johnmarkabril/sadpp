	                ...
	                <div class="col-sm-12 block-3 section-description wow fadeIn">
						...
						<div id="search">
							<div class="w3-container w3-lobster">
								<p class="w3-xxxlarge">Data of Death</p>
							</div>
							...
							<table border="1">
								...
								<tr>
									...
									<th><center> Date of Death </th>
									<th><center> Date of Interment </th>
									<th><center> Age </th>
									<th><center> Status </th>
									<th><center> Parent's Name </th>
									<th><center> Address </th>
									<th><center> Sacrament </th>
									<th><center> Cause of Death </th>
									<th><center> Cemetery </th>
									<th><center> Classis </th>
								...
								<tbody class="list">
									...
									?>
											<tr>
												...
												<td class=""><?php echo $row['namatay']; ?></td>
												<td class=""><?php echo $row['nilibing']; ?></td>
												<td class=""><?php echo $row['age']; ?></td>
												<td class=""><?php echo $row['status']; ?></td>
												<td class=""><?php echo $row['pname']; ?></td>
												<td class=""><?php echo $row['address']; ?></td>
												<td class=""><?php echo $row['sacrament']; ?></td>
												<td class=""><?php echo $row['kinamatay']; ?></td>
												<td class=""><?php echo $row['cemetery']; ?></td>
												<td class=""><?php echo $row['classis']; ?></td>
